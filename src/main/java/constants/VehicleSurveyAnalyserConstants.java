...
public class VehicleSurveyAnalyserConstants {
    public static final String DATA_FILE = System.getProperty("user.dir") + "/src/main/java/resources/Vehicle Survey Coding Challenge sample data.txt";
    ...
    public static final String TOTAL_VEHICLE_COUNT = "\t\t\tTotal vehicle count: ";
    public static final String NORTH_VEHICLES_COUNT = "\t\t\ttotal vehicle count moving in North direction: ";
    public static final String SOUTH_VEHICLES_COUNT = "\t\t\ttotal vehicle count moving in South direction: ";
